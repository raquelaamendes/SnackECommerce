...
public class UsersController : ControllerBase
{
    ...
    {
        var checkUser = await dbContext.Users.FirstOrDefaultAsync(u => u.Email == user.Email);

        if (checkUser is not null)
        {
            return BadRequest("Já existe utilizar com este email");
        }
    ...
    {
        var currentUser = await dbContext.Users.FirstOrDefaultAsync(u =>
    ...
    public async Task<IActionResult> UploadUserPhoto(IFormFile image)
    {
        ...
        {
            // Gera um nome de arquivo unico para a image enviada 
            ...
            // Atualiza a propriedade Urlimage do usuário com a URL da image enviada
    ...
    public async Task<IActionResult> GetUserImage()
    {
        ...
        var userImage = await dbContext.Users
